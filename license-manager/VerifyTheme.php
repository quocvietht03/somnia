  ...
  class VerifyTheme_Admin {
      ...
      public static function enqueue_admin_assets( $hook ) : void {
          ...
          wp_localize_script(
              ...
              [
                  ...
                  'strings'  => [
                      'confirm_import'            => __( 'Please activate the Theme License to unlock Demo Import, Plugin updates, and Official Support.', 'somnia' ),
                      'deactivate_confirm'        => __( 'Are you sure you want to deregister this license on this site?', 'somnia' ),
                      'please_enter_purchase_code'=> __( 'Please enter a purchase code.', 'somnia' ),
                      'ajax_error'                => __( 'AJAX error. Please try again.', 'somnia' ),
                      'verifying'                 => __( 'Verifying...', 'somnia' ),
                      'processing'                => __( 'Processing...', 'somnia' ),
                      'license_activated'         => __( 'License activated.', 'somnia' ),
                      'license_deactivated'       => __( 'License deactivated.', 'somnia' ),
                      'activation_failed'         => __( 'Activation failed.', 'somnia' ),
                      'deactivation_failed'       => __( 'Deactivation failed.', 'somnia' ),
                      'too_many_attempts'         => __( 'Too many attempts. Try again later.', 'somnia' ),
                      'unauthorized'              => __( 'Unauthorized', 'somnia' ),
                  ],
              ]
          );
      }
      ...
      public static function render_admin_page() : void {
          ...
          <div class="wrap verifytheme-wrap">
            <div class="__header">
                <h1><?php printf(__('Welcome to %s 🎉', 'somnia'), $theme_name); ?></h1>
                <h2><?php printf(__('Thank you for choosing %s.', 'somnia'), $theme_name); ?></h2>
                <p>
                    <?php esc_html_e('Activate your license to enable updates and import demos in one click.', 'somnia'); ?><br/>
                    <?php esc_html_e('Follow the steps to get your Envato purchase code.', 'somnia'); ?>
                    <a href="<?php echo esc_url('https://beplusthemes-docs.vercel.app/product-registration'); ?>" target="_blank"><?php esc_html_e('Click here.', 'somnia'); ?></a>
                </p>
            </div>
              
              <div class="verifytheme-form">
                <label for="verify_purchase_code"><?php esc_html_e( 'Purchase code', 'somnia' ); ?></label>
                ...
                <p class="description"><?php esc_html_e( 'Enter purchase code and click Activate.', 'somnia' ); ?></p>
                <div class="verifytheme-buttons">
                    <button id="verify_activate" class="button button-primary" <?php if( $is_activated ) echo 'disabled'; ?>>
                        <?php esc_html_e( 'Activate', 'somnia' ); ?>
                    </button>
                    <button id="verify_deactivate" class="button" <?php if( ! $is_activated ) echo 'disabled'; ?>>
                        <?php esc_html_e( 'Deactivate', 'somnia' ); ?>
                    </button>
                </div>
                <?php if ( $is_activated ) : ?>
                    <div class="verifytheme-success">
                        <?php printf( esc_html__( 'License activated successfully on: %s ', 'somnia' ), esc_html( $domain ) ); ?><br/>
                        <a href="<?php echo esc_url('themes.php?page=dummy-pack-center'); ?>"><?php esc_html_e('Import Demo Content', 'somnia'); ?></a>
                    </div>
                <?php endif; ?>
              ...
              <div class="verifytheme-help">
                    <ul>
                        <li><a href="https://beplusthemes-docs.vercel.app/somnia" target="__blank"><?php esc_html_e('📘 Documentation', 'somnia'); ?></a></li>
                        <li><a href="https://beplusthemes.com/our-support/" target="__blank"><?php esc_html_e('💬 Support Center', 'somnia'); ?></a></li>
                    </ul>
              </div>
          </div>
          <?php
