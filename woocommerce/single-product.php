	...
	<div class="bt-container">
		...
		<div class="bt-product-navigation">
			...
			<?php endif; ?>
				...
				<div class="bt-delimiter"><a href="<?php echo get_permalink(wc_get_page_id('shop')); ?>" class="shop-page"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
