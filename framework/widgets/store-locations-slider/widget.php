...
namespace SomniaElementorWidgets\Widgets\StoreLocationsSlider;
...
class Widget_StoreLocationsSlider extends Widget_Base
{
    ...
    {
        return __('Store Locations Slider', 'somnia');
    }
    ...
    protected function register_content_section_controls()
    {
        ...
        $repeater->add_control(
            'title_store',
            [
                'label' => __('Name Store', 'somnia'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Name Store', 'somnia'),
            ]
        );
        $repeater->add_control(
            'address_store',
            [
                'label' => __('Address Store', 'somnia'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Address Store', 'somnia'),
            ]
        );
        $repeater->add_control(
            'phone_store',
            [
                'label' => __('Phone Store', 'somnia'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Phone Store', 'somnia'),
            ]
        );
        $repeater->add_control(
            'email_store',
            [
                'label' => __('Email Store', 'somnia'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Email Store', 'somnia'),
            ]
        );
        ...
        $repeater->add_control(
            'maps_link',
            [
                'label' => __('Google Maps Link', 'somnia'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://maps.google.com/?q=...', 'somnia'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
                ...
                'description' => __('Enter the Google Maps link for this store location', 'somnia'),
            ]
        );
        ...
        $this->add_control(
            'store_locations',
            [
                'label' => __('Store Locations', 'somnia'),
                ...
                'default' => [
                    [
                        ...
                        'title_store' => __('Store Name', 'somnia'),
                        'address_store' => __('123 Store Address', 'somnia'),
                        'phone_store' => __('(123) 456-7890', 'somnia'),
                        'email_store' => __('store@example.com', 'somnia'),
                        'product' => '',
                        'maps_link' => [
                            ...
                            <div class="bt-store-locations-slider--item">
                                    ...
                                    <div class="bt-cover-image">
                                        ...
                                        if (!empty($item['image_store']['id'])) {
                                            ...
                                            if (!empty($item['image_store']['url'])) {
                                                echo '<img src="' . esc_url($item['image_store']['url']) . '" alt="' . esc_html__('Awaiting product image', 'somnia') . '">';
                                            } else {
                                ...
                                <div class="bt-store-locations-slider--content">
                                    ...
                                    <div class="bt-store-locations-slider--maps">
                                        <a href="<?php echo esc_url($item['maps_link']['url']); ?>" <?php echo esc_attr($item['maps_link']['is_external'] ? 'target="_blank"' : ''); ?>><?php echo esc_html__('View On Map', 'somnia'); ?></a>
                                    </div>
                                    <div class="bt-store-locations-slider--phone"><?php echo esc_html__('Phone: ', 'somnia'); ?><a href="tel:<?php echo esc_attr(str_replace(' ', '', $item['phone_store'])); ?>"><?php echo esc_html($item['phone_store']); ?></a></div>
                                    <div class="bt-store-locations-slider--email"><?php echo esc_html__('Email: ', 'somnia'); ?><a href="mailto:<?php echo esc_attr($item['email_store']); ?>"><?php echo esc_html($item['email_store']); ?></a></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
