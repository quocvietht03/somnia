...
namespace SomniaElementorWidgets\Widgets\PageBreadcrumb;
...
class Widget_PageBreadcrumb extends Widget_Base
{
	...
	{
		return __('Page Breadcrumb', 'somnia');
	}
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			'text_color_hover',
			[
				'label' => __('Text Color Hover', 'somnia'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-page-breadcrumb' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Text Typography', 'somnia'),
				'default' => '',
...
?>
		<div class="bt-elwg-page-breadcrumb">
			<div class="bt-page-breadcrumb">
				<?php
				$home_text = esc_html__('Home', 'somnia');
				$delimiter = '/';
				echo somnia_page_breadcrumb($home_text, $delimiter);
				?>
			</div>
		</div>
<?php
