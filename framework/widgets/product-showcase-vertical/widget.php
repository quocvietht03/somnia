...
namespace SomniaElementorWidgets\Widgets\ProductShowcaseVertical;
...
class Widget_ProductShowcaseVertical extends Widget_Base
{
	...
	{
		return __('Product Showcase Vertical', 'somnia');
	}
			...
			if ($query->have_posts()) :
				while ($query->have_posts()) : $query->the_post();
					...
					if (has_post_thumbnail($product_id)) {
						...
						$product_thumbnail = '<img src="' . esc_url(wc_placeholder_img_src('woocommerce_thumbnail')) . '" alt="' . esc_html__('Awaiting product image', 'somnia') . '" class="wp-post-image" />';
					}

					// Get up to 3 gallery images, use placeholder for missing ones
					$gallery_images = array();
					$gallery_image_ids = $product->get_gallery_image_ids();
					$placeholder_img = '<img src="' . esc_url(wc_placeholder_img_src('woocommerce_thumbnail')) . '" alt="' . esc_html__('Awaiting product image', 'somnia') . '" class="wp-post-image" />';
						...
						<div class="bt-product-showcase--content">
							...
							<div class="bt-product--infor">
								<div class="bt-product--info">
									...
									<?php endif; ?>
									<?php do_action('somnia_woocommerce_show_product_loop_sale_flash'); ?>
								</div>
								...
								<div class="bt-product--button">
									<a href="<?php echo esc_url($product_link); ?>" class="bt-btn bt-btn-view-details">
										<?php echo esc_html__('View Details', 'somnia'); ?>
									</a>
								</div>
							</div>
						</div>
