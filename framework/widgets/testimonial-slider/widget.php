...
namespace SomniaElementorWidgets\Widgets\TestimonialSlider;
...
class Widget_TestimonialSlider extends Widget_Base
{
    ...
    {
        return __('Testimonial Slider', 'somnia');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Select the position of the testimonial image relative to the content.', 'somnia'),
            ]
        );
