	...
	<div class="bt-main-content-ss">
		<div class="bt-container">
			<div class="bt-404-error">
				<h2><?php echo esc_html_e('404', 'somnia'); ?></h2>
				<h3><?php esc_html_e("Oops! That page can't be found.", "somnia"); ?></h3>
				<p><?php esc_html_e("We're really sorry but we can't seem to find the page you were looking for.", "somnia") ?></p>
				<a href="<?php echo esc_url(home_url()); ?>" class="bt-primary-btn bt-button bt-button-hover">
					<?php echo esc_html_e('Back To Homepage', 'somnia'); ?>
